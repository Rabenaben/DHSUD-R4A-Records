<div class="relative z-50 mr-2 flex items-center" x-data="notificationBell()">
    <x-dropdown align="right" width="96"
        contentClasses="p-4 w-80 sm:w-96 z-50 x-cloak bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 rounded-lg shadow-xl">
        <x-slot name="trigger">
            <button
                ...
                x-model="isOpen" :class="count > 0 ? 'ring-2 ring-red-500 animate-pulse' : ''" title="Notifications">
        ...
        <x-slot name="content">
            <div class="mb-4 flex items-center justify-between border-b pb-4">
                ...
                <span class="text-sm font-medium text-gray-500 dark:text-gray-400"
                    x-text="count > 0 ? count + ' item' + (count > 1 ? 's' : '') : 'No'"></span>
            </div>
