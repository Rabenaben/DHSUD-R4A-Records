<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl p-4">
        ...
        <div class="space-y-4">
            ...
            <x-status-cards :totalDockets="$totalDockets" :onShelf="$onShelf" :archived="$archived" :unavailable="$unavailable" :borrowed="$borrowed" theme="hoa" />
        ...
        <x-export-modal type="hoa" :provinces="$provinces" />
