    ...
    <div class="flex max-h-[90vh] min-h-[90vh] flex-col gap-6 overflow-hidden p-4 lg:flex-row">
        ...
        <div class="flex basis-3/4 flex-col items-center">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="rem-files-search" type="text" placeholder="Search files...">
                            <button
                                class="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 text-gray-400 hover:text-gray-600"
                                id="rem-files-search-clear" style="display: none;">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M6 18L18 6M6 6l12 12"></path>
                                </svg>
            ...
            <div class="flex h-full w-full flex-col rounded-lg border border-gray-300 bg-gray-100"
                    ...
                    <div class="ml-4 flex flex-1 items-center justify-center">
                        ...
                        @unless (auth()->user()->role === 'Staff')
                            <div class="ml-2 flex items-center space-x-2" id="rem-file-edit-actions">
                                ...
                                <button class="text-blue-600 hover:text-blue-800" id="export-rem-btn" title="Export File"
                                    onclick="exportRemFile()">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button class="text-red-600 hover:text-red-800" id="archive-rem-btn"
                                    title="Archive File">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="h-[90%] w-full flex-1" id="rem-file-preview-container">
